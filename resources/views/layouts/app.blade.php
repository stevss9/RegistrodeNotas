...
<head>
    ...
    <title>{{ config('app.name', 'DesarrolloWeb') }}</title>
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        @else
                            @if (@Auth::user()->hasRole('admin'))
                                <a class="nav-item nav-link active" href="{{ route('home') }}">Inicio<span
                                        class="sr-only">(current)</span></a>
                                <a class="nav-item nav-link" href="{{ route('alumnos.index') }}">Estudiantes</a>
                                <a class="nav-item nav-link" href="{{ route('profesor.index') }}">Docentes</a>
