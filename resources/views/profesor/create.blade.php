        ...
        <div class="login-page" style="width: 800px">
            <div class="form">
                <form class="mt-5" action="{{ route('profesor.store') }}" method="POST">
                    {!! csrf_field() !!}
                    <h2><i class="fas fa-user-plus"></i> Registro de Docentes</h2>
                    <br><br>
                    <div class="form-group row" >
                        ...
                        <div class="col">
                            <div class="form-group" style="text-align: left">
                                <label for="dui">Cédula</label>
                                <input id="dui" type="number" class="form-control" name="dui"
                                    placeholder="Cédula" required value="{{ old('dui') }}">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group" style="text-align: left">
                    ...
                    <a class="btn" href="{{ route('profesor.index') }}"  style="color:black" style="background-color: wheat"><i class="bi bi-arrow-90deg-down"></i>
                        Volver</a>
                </form>
