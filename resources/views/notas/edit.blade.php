...
@section('content')
    ...
    <head>
        ...
        <title>Editar Notas desde Admin</title>
    ...
    <body>
        <div class="login-page" style="width: 800px">
            ...
            <div class="form container1 ">
                <h2 style="text-align: center">Editar Notas</h2>
                <form class="mt-5" action="{{ route('notas.update', $nota->idnota) }}" method="POST">
                        ...
                        @if ($alumnos && $profesores)
                                    ...
                                    <select id="pro" class="form-control" name="idprofesor" placeholder="Profesor"
                                        ...
                                        @foreach ($profesores as $profesor)
                                            <option value="{{ $profesor->idprofesor }}"
                                                @if ($profesor->idprofesor == $nota->idprofesor) selected="selected" @endif>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select id="cur" class="form-control" name="idcursos" placeholder="Curso"
                                        required>
                    ...
                    <center>
                      ...
                      <a href="{{ route('notas.index') }}" class="btn mt-5 mb-3" style="color: black">Regresar</a>
                    </center>
